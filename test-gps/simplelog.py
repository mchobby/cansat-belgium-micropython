...
LOG_FILE = '/gps.dat'      # Example for writing to SD card path /sd/gps.txt
...
uart = machine.UART(0, rx=machine.Pin(1), tx=machine.Pin(0), baudrate=9600, timeout=3000) 
